...
const addTransferEntry = `-- name: AddTransferEntry :one
...
type AddTransferEntryParams struct {
	FromAccountID int64 `json:"from_account_id"`
	ToAccountID   int64 `json:"to_account_id"`
	Amount        int64 `json:"amount"`
}

func (q *Queries) AddTransferEntry(ctx context.Context, arg AddTransferEntryParams) (Transfer, error) {
	row := q.db.QueryRowContext(ctx, addTransferEntry, arg.FromAccountID, arg.ToAccountID, arg.Amount)
	var i Transfer
	err := row.Scan(
		&i.ID,
		&i.FromAccountID,
